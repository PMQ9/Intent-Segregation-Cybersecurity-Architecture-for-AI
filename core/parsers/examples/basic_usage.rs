use intent_parsers::{ParserEnsemble, ParserConfig, EnsembleResult};
...
async fn main() -> anyhow::Result<()> {
    ...
    let result5 = ensemble.parse_all(input5, "demo_user", "demo_session_5").await;
